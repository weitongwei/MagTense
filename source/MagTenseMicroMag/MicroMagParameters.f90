...
include "mkl_dfti.f90"    
   ...
   !> Stores a table in one variable
    ...
    type MicroMagProblem
        ...
        real(SP) :: A0,Ms,K0,gamma,alpha0,MaxT0         !> User defined coefficients determining part of the problem.
        real(SP) :: tol,thres_value                     !> User defined coefficients for the ODE solver
        ...
        real(SP),dimension(:),allocatable :: t          !> Time array for the desired output times
        real(SP),dimension(:),allocatable :: m0         !> Initial value of the magnetization
    ...
    type MicroMagSolution
        ...
        real(SP),dimension(:),allocatable :: HhX,HhY,HhZ                   !> Effective fields for the external field (X,Y and Z-directions, respectively)
        real(SP),dimension(:),allocatable :: HkX,HkY,HkZ                   !> Effective fields for the anisotropy energy term (X,Y and Z-directions, respectively)        
